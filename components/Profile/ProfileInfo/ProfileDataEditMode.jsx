...
const ReduxEditModeForm = reduxForm({ form: "profileDataEditMode" })(ProfileDataEditMode)
...
export default connect (mapStateToProps,{saveProfile, setEditMode, setSuccess})(EditForm);